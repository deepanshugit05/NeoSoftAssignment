...
public class ProjectDto {
	 ...
	 * 
	 * @NotEmpty(message = "ProjectName cannot be null, Please provide valid data")
	 * String projectName, LocalDateTime projectDuration) { super(); this.projectId
	 * = projectId; this.projectName = projectName; this.projectDuration =
	 * projectDuration; }
	 * 
	 ...
	 * 
	 * @Override public String toString() { return "ProjectDto [projectId=" +
