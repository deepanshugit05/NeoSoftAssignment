...
public class ExceptionalHandler {
	...
	public ResponseEntity<ErrorDetails> handleExceptions(NullParameterException ex){
		List<String> errorList=new ArrayList<>();
		errorList.add("Bad Request , Please provided valid input.");
		ErrorDetails errorDetails=new ErrorDetails("ASS400", ex.getMessage(), errorList);
		return new ResponseEntity<>(errorDetails,HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorDetails> handleExceptions(EmployeeNotFoundException ex){
		List<String> errorList=new ArrayList<>();
